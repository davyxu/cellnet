...
type ContextSet interface {
	...
	GetString(key interface{}) (ret string)

	GetBool(key interface{}) (ret bool)

	GetInt(key interface{}) (ret int)

	GetInt32(key interface{}) (ret int32)
